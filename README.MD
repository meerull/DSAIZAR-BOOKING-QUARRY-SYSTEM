...
Create a Database with the name soil-order

Click on the “Import” tab and choose the database file (soil-order.sql) which is provided under the folder naming “DATABASE FILE”.

After setting up all these, go to the URL “http://localhost/soil-order/"

To login to admin portal , go to the URL "http://localhost/soil-order/admin/login.php" with the following user name and password
