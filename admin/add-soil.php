            ...
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name!="")
                    {
                        ...
                        $image_name = "soil-Name-".rand(0000,9999).".".$ext; //New Image Name May Be "soil-Name-657.jpg"
                        ...
                        //Finally Uppload the soil image
                        ...
                        if($upload==false)
                        {
                            ...
                            //REdirect to Add soil Page with Error Message
                ...
                //Create a SQL Query to Save or Add soil
                ...
                //4. Redirect with MEssage to Manage soil page
                if($res2 == true)
                {
